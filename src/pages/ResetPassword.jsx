...
function ResetPassword() {
  ...
  return (
    ...
    {!isEmailSent &&
      ...
      <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-ig shadow-lg w-96 text-sm'>
    ...
    {isOtpSubmitted && isEmailSent &&
      <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-ig shadow-lg w-96 text-sm'>
